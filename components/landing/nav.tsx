...
export function Nav({ isAnalyse = false }: { isAnalyse?: boolean }) {
        ...
        {isAnalyse ? (
          <>
            <li>
              <button
                type="button"
                className="bg-bg-dark inline-flex h-[35px] cursor-pointer items-center gap-2 rounded-full border-none px-[22px] font-[inherit] text-[0.82rem] leading-none font-semibold text-white shadow-[0_2px_8px_rgba(20,16,36,0.15)] transition-all duration-250 hover:-translate-y-[1px] hover:bg-[#2a2550] hover:shadow-[0_4px_16px_rgba(30,26,58,0.4)]"
              >
            ...
            <li>
              <Link
                href="/"
                className="bg-primary hover:bg-accent-light inline-flex h-[35px] items-center rounded-full px-[22px] text-[0.82rem] leading-none font-semibold text-white shadow-[0_2px_8px_rgba(79,60,224,0.3)] transition-all duration-250 hover:-translate-y-[1px] hover:shadow-[0_4px_16px_rgba(79,60,224,0.35)]"
              >
